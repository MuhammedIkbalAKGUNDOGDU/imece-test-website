...
const Register = () => {
  ...
  const errorTranslations = {
    ...
    "Invalid role. Please select 'ALICI' or 'SATICI'.": "Geçersiz rol. Lütfen 'ALICI' veya 'SATICI' olarak seçin.",
  };
  ...
  const formatErrorMessage = (error) => {
    ...
    return translateError(error.response?.data?.message || "Kayıt sırasında bir hata oluştu.");
  };
