    ...
    <div className="auth-container">
      <div className="auth_inner_container">
        ...
        <form class="login-form">
            ...
            <label className="green underlined login-label" for="email">Kullanıcı Adı</label>
            <input className="login-input" type="email" id="email" placeholder="E postanı gir" required/>
        ...
        <div className="login-redirect">Henüz kurulmuş bir hesabınız yok mu? <span className="green pointer" onClick={goToOtherPage}>Şimdi oturum açın</span></div>
